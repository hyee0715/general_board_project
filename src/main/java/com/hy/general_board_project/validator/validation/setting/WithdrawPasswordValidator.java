...
public class WithdrawPasswordValidator implements ConstraintValidator<WithdrawPassword, String> {

    @Autowired
    SettingService settingService;

    @Override
    public void initialize(WithdrawPassword constraintAnnotation) {
